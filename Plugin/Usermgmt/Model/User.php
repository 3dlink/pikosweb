...
class User extends UserMgmtAppModel {
	...
	var $belongsTo = array('Usermgmt.UserGroup','Estado');
	...
	function RegisterValidate() {
		$validate1 = array(
				...
				'username'=> array(
					...
					'mustUnique'=>array(
						'rule' =>'isUnique',
						'message' =>'Este usuario está registrado',
					'last'=>true),
					'mustBeLonger'=>array(
						'rule' => array('minLength', 4),
						'message'=> 'Nombre de usuario debe ser mayor a 3 dígitos',
						'last'=>true),
					),
				'first_name'=> array(
					'mustNotEmpty'=>array(
				...
				'oldpassword'=>array(
					'mustNotEmpty'=>array(
						'rule' => 'notEmpty',
						'message'=> 'Introduzca la contraseña anterior',
						'last'=>true),
					'mustMatch'=>array(
				...
				'password'=>array(
					...
					'mustMatch'=>array(
						'rule' => array('verifies'),
						'message' => 'Ambas contraseñas deben coincidar'),
						//'on' => 'create'
					),
				'captcha'=>array(
					'mustMatch'=>array(
